...
def filter_list(province_history_id):
    compare_list = []
    compare_list.extend(sea_or_lake_id)
    compare_list.extend(wasteland_id)
    #compare_list = str(compare_list)
    print(compare_list)
...
if province_history_present is True:
    province_history_id = filter_list(province_history_files(province_history_path))
